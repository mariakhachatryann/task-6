    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo02">
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <?php if(empty($_SESSION['admin']) && empty($_SESSION['customer'])): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?action=adminLoginView">Admin Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?action=loginView">Customer Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?action=signView">Signup</a>
                    </li>
                <?php elseif(isset($_SESSION['admin']) && empty($_SESSION['customer'])): ?>
                    <li class="nav-item">
                ...
                <?php elseif(isset($_SESSION['customer']) && empty($_SESSION['admin'])): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?action=customerLogout">Logout</a>
                    </li>
